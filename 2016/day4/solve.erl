...
parse(S) ->
    ...
    {lists:flatten(lists:reverse(L)), list_to_integer(Id), Checksum}.
...
test() ->
    {"aaaaabbbzyx", 123, "abxyz"} = parse("aaaaa-bbb-z-y-x-123[abxyz]"),
    {"abcdefgh", 987, "abcde"} = parse("a-b-c-d-e-f-g-h-987[abcde]"),
